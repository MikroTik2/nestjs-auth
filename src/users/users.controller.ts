...
export class UsersController {
     ...
     @ApiOkResponse({ description: 'The users were successfully obtained.', type: [User] })
     ...
     @ApiOkResponse({ description: 'The user was successfully obtained.', type: User })
     ...
     @ApiOkResponse({ description: 'The user was successfully updated.', type: User })
     async update(@Param() { userId }: FindOneParams, @Body() updateUserDto: UpdateUserDto ): Promise<User> {
          return this.usersService.updateById(userId, updateUserDto);
     };

     @Delete(':userId')
     @ApiOperation({ description: 'Delete a user by userId.' })
     @ApiOkResponse({ description: 'The user was successfully deleted.', type: DeleteUserResponse })
